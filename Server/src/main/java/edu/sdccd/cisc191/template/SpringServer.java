...
public class SpringServer {
    ...
    CommandLineRunner initDatabase(IngredientRepository repository) {
        return args -> {
            ...
            ingredientList.add(new Ingredient("Coffee Beans", Ingredient.Units.LB,25));
            ingredientList.add(new Ingredient("Creamer", Ingredient.Units.OZ,100));
            ingredientList.add(new Ingredient("Sugar", Ingredient.Units.LB,40));
            ingredientList.add(new Ingredient("Flour", Ingredient.Units.LB,75));
            ingredientList.add(new Ingredient("Butter", Ingredient.Units.LB,20));
