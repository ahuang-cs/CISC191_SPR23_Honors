   ...
   public Recipe(Ingredient[] ingredients){
    ...
    public void addIngredient(Ingredient ingredient){
        if(!ingredients.contains(ingredient)) {
            ...
            System.out.println("Can't add ingredient " +  ingredient.getName() + " to recipe, this recipe already contains this ingredient.");
        }
    }
    ...
    public void removeIngredient(Ingredient ingredient){
        if(ingredients.contains(ingredient)) {
            ...
            System.out.println("Can't remove ingredient " +  ingredient.getName() + " to recipe, this recipe does not contain this ingredient.");
        }
    }
